...
import { listBigCommerceProducts } from "@/lib/commerce/providers/bigcommerce";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const remoteProducts = await listBigCommerceProducts(
      accessToken,
    ...
    const message =
      error instanceof Error
        ? error.message
        : "Failed to list BigCommerce products";
