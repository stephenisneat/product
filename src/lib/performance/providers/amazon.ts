import type { AmazonAdsClient } from "@/lib/channels/providers/amazon-ads";
import type {
...
export const amazonPerformanceProvider: PerformanceProvider = {
  provider: "amazon",
  async fetchDailyCampaignMetrics(
    ctx: PerformanceFetchContext,
    range: { startDate: string; endDate: string },
  ): Promise<PerformanceFetchResult> {
    const client = ctx.credentials as AmazonAdsClient;
