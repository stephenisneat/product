...
export function CreateAudioAdDialog({
  products,
  onCreated,
}: {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success("Audio creative started");
      setOpen(false);
      resetForm();
    ...
    >
      ...
      <DialogContent className="sm:max-w-md">
        <form onSubmit={(e) => void onSubmit(e)}>
          <DialogHeader>
            <DialogTitle>Create audio ad</DialogTitle>
            <DialogDescription>
              Generate a spoken script, then a voice spot for podcast and
              streaming ads.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="mt-4 space-y-4">
            <div className="space-y-2">
              <Label htmlFor="create-audio-product">Product</Label>
              <Select
                value={productId}
                onValueChange={(value) => {
              ...
              >
                <SelectTrigger id="create-audio-product" className="w-full">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={4}
                maxLength={4000}
                placeholder="Audience, offer, tone, length…"
                disabled={submitting}
              />
            </div>
