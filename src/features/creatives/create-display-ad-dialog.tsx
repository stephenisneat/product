...
export function CreateDisplayAdDialog({
  products,
  onCreated,
}: {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success("Display creative started");
      setOpen(false);
      resetForm();
      ...
      <DialogContent className="sm:max-w-md">
        <form onSubmit={(e) => void onSubmit(e)}>
          <DialogHeader>
            ...
            <DialogDescription>
              Generate copy (concept) then marketing images for Responsive
              Display Ads.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="mt-4 space-y-4">
            <div className="space-y-2">
              <Label htmlFor="create-display-product">Product</Label>
              <Select
                value={productId}
                onValueChange={(value) => {
              ...
              >
                <SelectTrigger id="create-display-product" className="w-full">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                maxLength={120}
                placeholder="Summer display set"
                disabled={submitting}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={4}
                maxLength={4000}
                placeholder="Tone, audience, offer, visual direction…"
                disabled={submitting}
              />
            </div>
